  ...
  const heroContent = [
    {
      ...
      description: 'Professional repair services for all your favorite devices with warranty guarantee',
      cta: 'Get Free Estimate',
    },
    {
      image: laptop,
      title: 'We Can Fix Your Problem',
      description: 'We provide the best gadget repair in Nigeria. Visit our store for a free estimate or mail your device from anywhere in Nigeria.',
      cta: 'Find Location',
    },
    {
      image: hero,
      title: 'On-Demand Mobile Repairs',
      description: 'Making mobile repairs more convenient for everyone with our expert technicians',
      cta: 'Book Service',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection variants={fadeInUp}>
            <div className="text-center mb-16">
              ...
              >
                Professional repair services for all your devices with 6-month warranty
              </motion.p>
            </div>
          </AnimatedSection>
            ...
            {[
              {
                icon: Smartphone,
                title: 'Mobile Phones',
                description: 'Screen repairs, battery replacement, water damage, and more',
                features: ['Screen Replacement', 'Battery Issues', 'Water Damage', 'Software Problems']
              },
              {
                icon: Laptop,
                title: 'Laptops & Computers',
                description: 'Hardware fixes, software issues, screen replacement and upgrades',
                features: ['Hardware Repair', 'Software Issues', 'Screen Replacement', 'Performance Upgrade']
              },
              {
                icon: Watch,
                title: 'Smart Watches',
                description: 'Battery, screen, and connectivity issues resolved professionally',
                features: ['Battery Replacement', 'Screen Repair', 'Connectivity', 'Software Update']
              },
            ].map((service, index) => (
              <AnimatedCard key={index} delay={index * 0.2}>
                ...
                >
                  <Card className="border-2 border-border bg-card text-card-foreground shadow-xl hover:shadow-2xl transition-all duration-300 group h-full">
          ...
          <AnimatedSection variants={fadeInUp}>
            <div className="text-center mb-16">
              ...
              <motion.p 
                ...
                transition={{ delay: 0.2, duration: 0.6 }}
              >
                Whether you want to learn new skills or build a career, we have opportunities for you
              </motion.p>
            </div>
          </AnimatedSection>

          <div className="max-w-6xl mx-auto">
            <Tabs defaultValue="academy" className="w-full" onValueChange={setActiveTab}>
              {/* Modern Tab List */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                      ...
                      <div className="p-8 lg:p-12">
                        ...
                        >
                          <div className="flex items-center space-x-4 mb-6">
                            ...
                            <div>
                              ...
                              <div className="flex items-center space-x-1 mt-2">
                                ...
                                <span className="ml-2 text-sm text-muted-foreground">4.9/5 (500+ students)</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <Button 
                            onClick={() => router.push("/academy")}
                            variant="outline" className="border-border text-card-foreground hover:bg-muted px-8 py-3 rounded-xl">
                              View Curriculum
                            </Button>
                          </div>
                        </motion.div>
                      ...
                      <div className="bg-gradient-to-br from-primary/10 to-primary/5 p-8 lg:p-12 flex items-center justify-center">
                        ...
                        >
                          ...
                          <div className="bg-card rounded-2xl p-6 shadow-lg">
                            <p className="text-sm text-muted-foreground mb-2">Next Cohort Starts</p>
                            <p className="text-2xl font-bold text-card-foreground">March 1, 2024</p>
                            <p className="text-xs text-muted-foreground mt-2">Limited seats available</p>
                          </div>
                        </motion.div>
                      </div>
                    </div>
                        ...
                        >
                          <div className="flex items-center space-x-4 mb-6">
                            ...
                            <div>
                              ...
                              <p className="text-muted-foreground mt-2">Build your repair business with us</p>
                            </div>
                          </div>
                          ...
                          <div className="mb-6 p-6 bg-primary/5 rounded-2xl">
                            <div className="text-center">
                              ...
                              <p className="text-3xl font-bold text-card-foreground">₦150K - ₦400K</p>
                            </div>
                          </div>
                          ...
                          <div className="grid sm:grid-cols-2 gap-4 mb-8">
                            {[
                              { title: "Flexible Schedule", desc: "Choose your working hours" },
                              { title: "Modern Tools", desc: "Access to latest equipment" },
                              { title: "Training & Support", desc: "Continuous skill development" },
                              { title: "Growth Opportunities", desc: "Career advancement paths" }
                            ].map((benefit, index) => (
                              <motion.div 
                                key={index}
                        ...
                        >
                          ...
                          <div className="space-y-4">
                            <div className="bg-card rounded-2xl p-4 shadow-lg">
                              ...
                              <p className="text-2xl font-bold text-card-foreground">Up to 60%</p>
                            </div>
                            <div className="bg-card rounded-2xl p-4 shadow-lg">
                              <p className="text-sm text-muted-foreground">Support Available</p>
                              <p className="text-lg font-bold text-card-foreground">24/7</p>
                            </div>
                          </div>
                        </motion.div>
                      </div>
          ...
          <AnimatedSection variants={fadeInUp}>
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted max-w-2xl mx-auto">
                Experience the difference with our customer-focused approach and expert services
              </p>
            </div>
          </AnimatedSection>
          ...
          >
            {[
              ...
              },
              {
                icon: Clock,
                title: 'Fast Service',
                description: 'Quick turnaround times with same-day service options available',
              },
              {
                icon: MapPin,
                title: 'Nationwide Coverage',
                description: 'We come to you or visit our conveniently located service centers',
              },
            ].map((feature, index) => (
              <AnimatedCard key={index} delay={index * 0.2}>
                <motion.div
        ...
        <AnimatedSection variants={scaleIn}>
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <motion.p 
              ...
              viewport={{ once: true }}
            >
              Contact us today for a free estimate and experience the best gadget repair service in Nigeria
            </motion.p>
            <motion.div
